    ...
    <main class="flex-grow">
        <div class="min-h-screen bg-gray-50 py-8 md:py-12">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
                <div style="opacity: 1; transform: none;"><button
                    ...
                    <div
                                    ...
                                    <div class="space-y-4 rdp-caption_start rdp-caption_end">
                                        <div class="flex justify-center pt-1 relative items-center">
                                            <div class="text-sm font-medium" aria-live="polite" role="presentation"
                                                id="react-day-picker-49">July 2025</div>
                        ...
                        <div class="lg:col-span-2 space-y-6">
                            {{-- <div>
                                <h3 class="font-semibold text-foreground mb-3 text-lg">Available Slots for <span
                                        class="text-primary">July 31st, 2025</span></h3>
                                ...
                                @foreach ($teacher->lessonPackages as $package)
                                    <label for="package_{{ $package->id }}" class="block">
                                        ...
                                        <div
                                            ...
                                            border-muted peer-checked:border-primary/70 hover:border-primary/50">
                                            <h4 class="font-bold text-lg text-foreground">
                                                {{ $package->number_of_lessons }} Lessons
                                            </h4>
                                            ...
                                            <p class="text-xs text-muted-foreground">
                                                Just ${{ number_format($package->price / $package->number_of_lessons, 2) }}
                                                per lesson
                                            </p>
                                        </div>
                                    </label>
                        ...
                        <div class="lg:col-span-5" style="opacity: 1;">
                            <div class="bg-primary/10 p-4 rounded-lg border border-primary/30 text-center">
                                <p class="text-lg font-medium text-foreground"><span id="selected-duration">—</span></p>
                        ...
                        <div class="lg:col-span-5" style="opacity: 1;">
                            <form id="checkoutForm" action="{{ route('student.tutor.checkout') }}" method="GET">
                                ...
                                <button type="submit"
                                    class="inline-flex items-center justify-center rounded-md font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 w-full btn-red text-lg py-3"><svg
    ...
    <script>
        ...
        durationInputs.forEach(input => {
            input.addEventListener('change', function() {
                ...
                // Update Display
                selectedDurationElem.textContent = `${minutes} minutes`;
                selectedPriceElem.textContent = price ? `Rs. ${price}` : 'N/A';
