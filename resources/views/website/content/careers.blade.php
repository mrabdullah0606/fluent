...
@section('content')
    <main class="flex-grow">
        <div class="container mx-auto px-4 md:px-6 py-12 bg-background">
            <div class="mb-10" style="opacity: 1; transform: none;"><button
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                <div style="opacity: 1; transform: none;">
                    <div
                        ...
                        <div class="flex flex-col space-y-1.5 p-6">
                            <h3 class="font-semibold tracking-tight text-2xl text-primary">Senior Frontend Developer (React)
                            </h3>
                            <p class="text-sm text-muted-foreground">2025-05-15</p>
                        </div>
                        <div class="p-6 pt-0 space-y-3">
                            <div class="flex items-center text-sm text-foreground"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                    class="h-4 w-4 mr-2 text-secondary">
                                    <path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"></path>
                                    <circle cx="12" cy="10" r="3"></circle>
                                </svg> Remote (Global)</div>
                            <div class="flex items-center text-sm text-foreground"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                    class="h-4 w-4 mr-2 text-secondary">
                            ...
                            <div class="flex items-center text-sm text-foreground"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                </svg> $90k - $120k Annually</div>
                            <p class="text-muted-foreground text-sm pt-2 line-clamp-3">Join our passionate engineering team
                            ...
                            <div class="pt-2">
                                ...
                                <ul class="list-disc list-inside space-y-0.5">
                                    <li class="text-xs text-muted-foreground">5+ years of experience with React and modern
                                        JavaScript (ES6+).</li>
                                    <li class="text-xs text-muted-foreground">Strong proficiency in HTML, CSS, and
                                        TailwindCSS.</li>
                                    <li class="text-xs text-muted-foreground">...and more.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="flex items-center p-6 pt-0"><button
                            ...
                            <a href="{{route('apply.form')}}">Apply Now</a> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                <div style="opacity: 1; transform: none;">
                    <div
                        class="rounded-lg border bg-card text-card-foreground shadow-lg hover:shadow-xl transition-shadow border-primary/20">
                        <div class="flex flex-col space-y-1.5 p-6">
                            <h3 class="font-semibold tracking-tight text-2xl text-primary">Customer Support Specialist
                                (Multilingual)</h3>
                            <p class="text-sm text-muted-foreground">2025-06-01</p>
                        </div>
                        <div class="p-6 pt-0 space-y-3">
                            <div class="flex items-center text-sm text-foreground"><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="flex items-center text-sm text-foreground"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <line x1="12" x2="12" y1="2" y2="22"></line>
                                    <path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path>
                                </svg> $45k - $55k Annually</div>
                            <p class="text-muted-foreground text-sm pt-2 line-clamp-3">Provide exceptional support to our
                                global community of students and tutors. Help resolve issues, answer questions, and ensure a
                                positive experience on fluentAll.</p>
                            <div class="pt-2">
                                <h4 class="text-xs font-semibold text-primary mb-1">Key Qualifications:</h4>
                                <ul class="list-disc list-inside space-y-0.5">
                                    <li class="text-xs text-muted-foreground">2+ years of experience in customer support or
                                        a similar role.</li>
                                    <li class="text-xs text-muted-foreground">Excellent communication skills in English
                                        (C1/C2).</li>
                                    <li class="text-xs text-muted-foreground">...and more.</li>
                                </ul>
                            </div>
                        ...
                        <div class="flex items-center p-6 pt-0"><button
                                class="inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2 w-full btn-red">
                                <a href="{{route('apply.form2')}}">Apply Now</a> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" class="ml-2 h-4 w-4">
                                    <path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path>
                                    <polyline points="15 3 21 3 21 9"></polyline>
                ...
                <div style="opacity: 1; transform: none;">
                    <div
                        class="rounded-lg border bg-card text-card-foreground shadow-lg hover:shadow-xl transition-shadow border-primary/20">
                        <div class="flex flex-col space-y-1.5 p-6">
                            <h3 class="font-semibold tracking-tight text-2xl text-primary">Marketing Manager - Language
                                Learning</h3>
                            <p class="text-sm text-muted-foreground">2025-06-05</p>
                        </div>
                        <div class="p-6 pt-0 space-y-3">
                            <div class="flex items-center text-sm text-foreground"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"></path>
                                    <circle cx="12" cy="10" r="3"></circle>
                                </svg> Remote (US Timezone preferred)</div>
                            <div class="flex items-center text-sm text-foreground"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="h-4 w-4 mr-2 text-secondary">
                            ...
                            <div class="flex items-center text-sm text-foreground"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <line x1="12" x2="12" y1="2" y2="22"></line>
                                    <path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path>
                                </svg> $70k - $90k Annually</div>
                            <p class="text-muted-foreground text-sm pt-2 line-clamp-3">Develop and execute marketing
                                strategies to grow fluentAll's user base. Focus on digital marketing, content creation, and
                                community engagement.</p>
                            <div class="pt-2">
                                <h4 class="text-xs font-semibold text-primary mb-1">Key Qualifications:</h4>
                                <ul class="list-disc list-inside space-y-0.5">
                                    <li class="text-xs text-muted-foreground">3+ years of experience in digital marketing,
                                        preferably in EdTech or language learning.</li>
                                    <li class="text-xs text-muted-foreground">Proven track record of successful marketing
                                        campaigns.</li>
                                    <li class="text-xs text-muted-foreground">...and more.</li>
                                </ul>
                            </div>
                        ...
                        <div class="flex items-center p-6 pt-0"><button 
                                class="inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2 w-full btn-red">
                               <a href="{{route('apply.form3')}}">Apply Now</a> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" class="ml-2 h-4 w-4">
                                    <path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path>
                                    <polyline points="15 3 21 3 21 9"></polyline>
            ...
            <div class="mt-16 text-center bg-primary/10 p-8 rounded-xl border border-primary/20" style="opacity: 1;">
                ...
                <p class="text-muted-foreground mb-6 max-w-md mx-auto">We're always looking for talented individuals. Send
                    us your resume and tell us how you can contribute to fluentAll!</p><button
                    ...
                    <a href="{{route('apply.general')}}">Submit General Application</a> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round" class="ml-2 h-4 w-4">
                        <path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path>
                        <polyline points="15 3 21 3 21 9"></polyline>
