<aside class="sidebar">
    ...
    <a href="{{ route('admin.languages.index') }}"
        ...
        <i class="bi bi-translate me-2"></i> Languages Management
    </a>
    ...
    <a href="{{ route('admin.reviews.index') }}"
        class="nav-link {{ request()->routeIs('admin.careers.*') ? 'active' : '' }}">
        <i class="bi bi-star-fill me-2"></i> Reviews Management
    </a>
    ...
    <a href="{{ route('admin.wallet.withdrawals.index') }}" class="nav-link"><i class="bi bi-wallet2 me-2"></i>
