            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="btn-group" role="group">
                        <a href="https://app.chatwoot.com/app/accounts/131300/dashboard" target="_blank"
                        ...
                        @endif
                        <a href="{{ route('admin.customer.support.webhook.config') }}" class="btn btn-outline-info btn-sm">
                    ...
                    <div class="card border-warning">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3">
                                    <h6>System Status</h6>
                                    <button class="btn btn-sm btn-info" onclick="debugSSE.getSystemStatus()">Check
                                        Status</button>
                                    <button class="btn btn-sm btn-warning" onclick="debugSSE.clearCache()">Clear
                                        Cache</button>
                                </div>
                                <div class="col-md-3">
                                    <h6>Connection</h6>
                                    <button class="btn btn-sm btn-success" onclick="debugSSE.reconnect()">Reconnect
                                        SSE</button>
                                    <button class="btn btn-sm btn-secondary" onclick="debugSSE.forceReload()">Reload
                                        Messages</button>
                                </div>
                                <div class="col-md-3">
                                    <h6>Testing</h6>
                                    <button class="btn btn-sm btn-primary" onclick="debugSSE.testMessage()">Test
                                        Message</button>
                                    <button class="btn btn-sm btn-danger" onclick="debugSSE.clearProcessedIds()">Clear
                                        IDs</button>
                                </div>
                                <div class="col-md-3">
                                    <h6>Logging</h6>
                                    <button class="btn btn-sm btn-success" onclick="debugSSE.enableDebug()">Enable
                                        Debug</button>
                                    <button class="btn btn-sm btn-danger" onclick="debugSSE.disableDebug()">Disable
                                        Debug</button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Open Conversations
                                </div>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800" id="resolved-conversations">Loading...
                                </div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800" id="pending-conversations">Loading...
                                </div>
                            </div>
                            <div class="col-auto">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex justify-content-between align-items-center">
                        ...
                        <div id="typing-indicator"
                            style="font-style: italic; font-size: 0.9rem; color: #666; display:none;">
                            ...
                            <form onsubmit="sendQuickReply(event)">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="#" class="btn btn-outline-secondary btn-sm"
                                        onclick="openFullConversation()" target="_blank">
