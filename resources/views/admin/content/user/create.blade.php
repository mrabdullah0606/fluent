...
@section('content')
    <main class="main-content" id="language-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="fw-bold">Add New Language</h3>
                ...
                <form action="{{ route('admin.languages.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="language-name"
                            class="form-control @error('name') is-invalid @enderror" placeholder="e.g., English, Urdu"
                            required>
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="symbol" id="language-symbol"
                            class="form-control @error('symbol') is-invalid @enderror" placeholder="e.g., EN, UR" required>
                        @error('symbol')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
