            ...
            <div class="container mx-auto">
                ...
                <div style="opacity: 1; transform: none;">
                    ...
                    @if (isset($visibleMeetings) &&
                            count($visibleMeetings) === 0 &&
                            (isset($hiddenMeetings) && count($hiddenMeetings) === 0))
                    ...
                    @else
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-sm text-primary font-medium flex items-center">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                            ...
                                                            stroke-linejoin="round" class="mr-1 h-3.5 w-3.5">
                                                            <circle cx="12" cy="12" r="10"></circle>
                                                            <polyline points="12 6 12 12 16 14"></polyline>
                                                        </svg>
                        ...
                        <!-- Show More Button -->
                        @php
                            $hiddenCount = isset($hiddenMeetings)
                                ? count($hiddenMeetings)
                                : (isset($meetingDetails)
                                    ? count($meetingDetails) - 4
                                    : 0);
                        @endphp
