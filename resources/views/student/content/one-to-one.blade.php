                    ...
                    <div class="border border-primary/20 bg-white p-5 rounded-xl shadow-lg hover:shadow-xl transition-shadow md:flex gap-6"
                        ...
                        <div class="md:w-1/3 flex flex-col items-center text-center mb-4 md:mb-0"><img
                            ...
                            <div class="flex items-center text-yellow-500 mb-1">
                                ...
                                <span class="ml-1.5 text-muted-foreground text-xs">{{ __('welcome.key_562') }}</span>
                            </div>
                            ...
                            <button
                                ...
                                <a href="{{ route('tutor', ['id' => $teacher->id]) }}" class="...">{{ __('welcome.key_564') }}</a>

                            </button>
                        </div>
                        <div class="md:w-2/3">
                            <p class="text-muted-foreground text-sm leading-relaxed mb-3 line-clamp-3">{{ __('welcome.key_565') }}</p>
