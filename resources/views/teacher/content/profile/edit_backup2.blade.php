                ...
                <form action="{{ route('teacher.profile.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-6">
                        <div class="bg-white p-6 rounded-xl shadow-md border border-gray-200 mb-4">
                            <label for="headline" class="text-lg font-semibold flex items-center mb-3">Headline</label>
                            <input type="text" name="headline" id="headline" class="w-full rounded-md border px-3 py-2 text-sm bg-gray-50" value="{{ old('headline', $teacher?->headline) }}" placeholder="e.g. Certified English Tutor for Beginners">
                        </div>
                        <div class="bg-white p-6 rounded-xl shadow-md border border-gray-200 mb-4">
                            <label for="country" class="text-lg font-semibold flex items-center mb-3">Country</label>
                            <input type="text" name="country" id="country" class="w-full rounded-md border px-3 py-2 text-sm bg-gray-50" value="{{ old('country', $teacher?->country) }}" placeholder="Your country">
                        </div>
                        <div class="bg-white p-6 rounded-xl shadow-md border border-gray-200 mb-4">
                            <label for="rate_per_hour" class="text-lg font-semibold flex items-center mb-3">Rate per Hour ($)</label>
                            <input type="number" step="0.01" name="rate_per_hour" id="rate_per_hour" class="w-full rounded-md border px-3 py-2 text-sm bg-gray-50" value="{{ old('rate_per_hour', $teacher?->rate_per_hour) }}">
                        </div>
                        <div class="bg-white p-6 rounded-xl shadow-md border border-gray-200 mb-4">
                            <label for="teaches" class="text-lg font-semibold flex items-center mb-3">Subjects You Teach</label>
                            <input type="text" name="teaches" id="teaches"
                            class="w-full rounded-md border px-3 py-2 text-sm bg-gray-50"
                            value="{{ old('teaches', $teacher?->teaches) }}"
                            placeholder="e.g. English Grammar, Business English, IELTS">
                        </div>
                        <div class="bg-white p-6 rounded-xl shadow-md border border-gray-200 mb-4">
                            <label for="speaks" class="text-lg font-semibold flex items-center mb-3">Languages You Speak</label>
                            <input type="text" name="speaks" id="speaks"
                            class="w-full rounded-md border px-3 py-2 text-sm bg-gray-50"
                            value="{{ old('speaks', $teacher?->speaks) }}"
