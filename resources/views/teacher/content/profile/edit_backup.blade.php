                    ...
                    <div class="space-y-6">
                        <div class="bg-white p-6 rounded-xl shadow-md border border-gray-200"
                            ...
                            <textarea
                                ...
                                id="aboutMe" name="aboutMe" placeholder="Tell students a little about yourself..." rows="4">{{ __('welcome.key_335') }}</textarea>
                        </div>
                        <div class="bg-white p-6 rounded-xl shadow-md border border-gray-200"
                            style="opacity: 1; transform: none;"><label
                                class="peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-lg font-semibold text-foreground flex items-center mb-3"
                            ...
                            <textarea
                                ...
                                rows="4">{{ __('welcome.key_337') }}</textarea>
                        </div>
                        <div class="bg-white p-6 rounded-xl shadow-md border border-gray-200"
                            style="opacity: 1; transform: none;"><label
                                class="peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-lg font-semibold text-foreground flex items-center mb-3"
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-md border border-gray-200"
                            ...
                            <textarea
                                ...
                                placeholder="List any relevant certifications like TEFL, CELTA, or degrees." rows="2">{{ __('welcome.key_341') }}</textarea>
                        </div>
                        <div class="bg-white p-6 rounded-xl shadow-md border border-gray-200"
                            style="opacity: 1; transform: none;"><label
                                class="peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-lg font-semibold text-foreground flex items-center mb-3"
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-md border border-gray-200"
                            ...
                            <p class="text-xs text-muted-foreground mt-1">{{ __('welcome.key_345') }}</p>
                        </div>
                    </div>
